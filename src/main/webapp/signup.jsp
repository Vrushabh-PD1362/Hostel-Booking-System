						...
						<form action="user_register" method="post">
							<div class="mb-3">
								<label class="form-label"> <i
									class="fa-sharp fa-solid fa-person" style="font-size: 18px;"></i>
									Name
							...
							<div class="mb-3">
								<label class="form-label"><i
									...
									Email</label><input required name="email" type="email"
									class="form-control">
							</div>
							<div class="mb-3">
								<label class="form-label"><i
							...
							<button type="submit" class="btn bg-info text-white col-md-12">Sign
								Up</button>
